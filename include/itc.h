...
// Note to developers: First we set both bits to zero and then we set the bits
// to whatever the user gave.
#define _ITC_SET_PORT_SENSITIVITY(port, sensitivity) do {\
